class Talking extends Phaser.Scene {
    ...
    create() {
        ...
        this.ruin = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'ruin').setOrigin(0, 1)
        this.nuru = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'nuru').setOrigin(0, 1)
